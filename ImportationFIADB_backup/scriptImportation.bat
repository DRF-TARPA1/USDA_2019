...
call "loadReferenceTables.bat" > ..\ScriptOutputs\output_load_reference_tables.txt 2> ..\ScriptOutputs\output_load_reference_erreur.txt | "%s\psql" -h localhost -p 5432 -U postgres -d testdb
